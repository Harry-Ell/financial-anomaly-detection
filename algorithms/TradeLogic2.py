'''
This is similar to the previous case, but in essence is a mean reversion strategy. 

Fit PCs, and then smooth these. When correlation appears in noise, which essentially would just be 
a collection of residuals of a shared sign, bet on a mean reversion of this sudden breakout. 
'''
        ...
        if len(relevant) > 0:
            ...
            for idx, row in relevant.iterrows():
                ...
                if 0 <= j < len(self.tickers):
                    ...
                    # cancel any existing unwind plan; were actively trading this name
